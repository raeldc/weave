...
// Actions
import {replaceStyle, mergeStyle, getStyle, getCascade, removeProperties} from 'core/actions/styling.js'

export default class Font extends Component {

    initialState() {
        return {open: false, inputValue: ''}
    }
    ...
    render() {
        ...
        let options = [
            // Sans Serif
            {
                ...
                label: 'Avant Garde',
                value: '"Avant Garde", Avantgarde, "Century Gothic", CenturyGothic, "AppleGothic", sans-' +
                        'serif'
            }, {
                label: 'Calibri',
                ...
                value: '"Franklin Gothic Medium", "Franklin Gothic", "ITC Franklin Gothic", Arial, sans-' +
                        'serif'
            }, {
                label: 'Futura',
                ...
                label: 'Impact',
                value: 'Impact, Haettenschweiler, "Franklin Gothic Bold", Charcoal, "Helvetica Inserat",' +
                        ' "Bitstream Vera Sans Bold", "Arial Black", sans serif'
            }, {
                label: 'Lucida Grande',
                value: '"Lucida Grande", "Lucida Sans Unicode", "Lucida Sans", Geneva, Verdana, sans-ser' +
                        'if'
            }, {
                label: 'Optima',
                ...
                label: 'Segoe UI',
                value: '"Segoe UI", Frutiger, "Frutiger Linotype", "Dejavu Sans", "Helvetica Neue", Aria' +
                        'l, sans-serif'
            }, {
                label: 'Tahoma',
                ...
                label: 'Trebuchet MS',
                value: '"Trebuchet MS", "Lucida Grande", "Lucida Sans Unicode", "Lucida Sans", Tahoma, s' +
                        'ans-serif'
            }, {
                label: 'Verdana',
            ...
            {
                label: 'Baskerville',
                value: 'Baskerville, "Baskerville Old Face", "Hoefler Text", Garamond, "Times New Roman"' +
                        ', serif'
            }, {
                label: 'Big Caslon',
                ...
                label: 'Bodoni MT',
                value: '"Bodoni MT", Didot, "Didot LT STD", "Hoefler Text", Garamond, "Times New Roman",' +
                        ' serif'
            }, {
                label: 'Book Antiqua',
                ...
                label: 'Calisto MT',
                value: '"Calisto MT", "Bookman Old Style", Bookman, "Goudy Old Style", Garamond, "Hoefle' +
                        'r Text", "Bitstream Charter", Georgia, serif'
            }, {
                label: 'Cambria',
                ...
                label: 'Garamond',
                value: 'Garamond, Baskerville, "Baskerville Old Face", "Hoefler Text", "Times New Roman"' +
                        ', serif'
            }, {
                label: 'Georgia',
                ...
                label: 'Perpetua',
                value: 'Perpetua, Baskerville, "Big Caslon", "Palatino Linotype", Palatino, "URW Palladi' +
                        'o L", "Nimbus Roman No9 L", serif'
            }, {
                label: 'Rockwell',
            ...
            // Monospaced
            {
                ...
                value: '"Lucida Console", "Lucida Sans Typewriter", Monaco, "Bitstream Vera Sans Mono", ' +
                        'monospace'
            }, {
                label: 'Lucida Sans Typewriter',
                value: '"Lucida Sans Typewriter", "Lucida Console", Monaco, "Bitstream Vera Sans Mono", ' +
                        'monospace'
            }, {
                label: 'Monaco',
        ...
        if (options && options.length) {
            return options.map((option, i) => {
                ...
                return (
                    <li
                        className={className}
                        key={`value-${i}-{option.value}`}
                        onMouseOver={event => this.onOptionFocus(option, event)}
                        onMouseDown={event => this.onMouseDownOption(option, event)}
                        style={{
    ...
    applyFont(option) {
        if (option) {
            ...
            removeProperties(this.props.node, {
                fontFamily: ''
            }, this.props.device);
        }
    }
